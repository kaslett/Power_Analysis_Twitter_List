...
#Description:
#This code runs a power analysis for the Twitter List Project using either predicted data or past data from the following paper:
...
df_1 <- read.csv('./Data/Clean_NewsGuard_Survey_Study.csv')
df_2 <- read.csv('./Data/Clean_NewsGuard_Digital_Trace_Data.csv')
